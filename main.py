...
class Instagram:
    def __init__(self, proxy=None) -> None:
        self.mid = None
        self.csrf = None
        self.asbd_id = None # credits @ultve
        self.fbapp_id = None
        self.device_id = None
    ...
    def __base_headers(self, session: Session, addon=None) -> dict:
        ...
        __base_headers = {
            ...
            "Accept-Language": "en", # credits @ultve
            ...
            "X-IG-WWW-Claim": "0",
            "X-Mid": self.mid,
            "X-Instagram-AJAX": self.rollout_hash, # credits @ultve
    ...
    def __init_session(self, session: Session) -> dict: # credits @ultve
        headers = {
            "Authority": "www.instagram.com",
            "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
            "Accept-Language": "en",
...
# credits @ultve
    ...
    def __init_create(
        ...
        payload = {
            ...
            "client_id": self.mid,
            "seamless_login_enabled": "1",# credits @ultve
        ...
        response = session.post(
            ...
            proxies=self.proxies, # credits @ultve
        )
        print(response.text)
    ...
    def __create_account(
        ...
        first_name: str,
        signup_code: str,
    ) -> Response: # credits @ultve
        payload = {
            "enc_password": Utils.encrypt_password(password),
            "email": email,
            "username": username, # credits @ultve
            "first_name": first_name,
            "month": str(randint(1, 12)),
            "day": str(randint(1, 27)), # credits @ultve
...
# credits @ultve
    ...
    # credits @ultve    __signup_code = self.__verify_code(session, __email, __veri_code)
